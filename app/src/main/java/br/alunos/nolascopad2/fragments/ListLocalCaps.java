 ...
 * {@link ListLocalCaps.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ListLocalCaps#newInstance} factory method to
...
public class ListLocalCaps extends Fragment {
     ...
     * @return A new instance of fragment ListCaps.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(capitulos.size()==0){
            ...
            capRecyclerView = (RecyclerView) view.findViewById(R.id.capsRecyclerView);
            //Layout
        ...
        newcap = (FloatingActionButton) view.findViewById(R.id.addcapfab);
